...
wait
# decoder_main --beam 15.0 --lattice_beam 7.5 --max_active 7000  --blank_skip_thresh 0.98 --ctc_weight 0.6 --rescoring_weight 0.8 --fst_path data/lang_test/TLG.fst \
# --wav_scp raw_wav/train/azero_ripple.scp --model_path exp/conformer_unicode/final.zip --dict_path data/lang_test/words.txt --result exp/conformer_unicode/lm_with_runtime/pred.text
# Step 3. Merge files
for n in $(seq ${nj}); do
...
# Step 4. Compute WER
python tools/compute-wer.py --char=1 --v=1   $label_file $dir/text > $dir/wer
