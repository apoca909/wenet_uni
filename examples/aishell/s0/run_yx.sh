...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    for ((i = 0; i < $num_gpus; ++i)); do
    {
        ...
        python wenet/bin/train.py --gpu $gpu_id \
            --config $train_config \
            --train_data $feat_dir/$train_set/train_yx.data \
            --cv_data $feat_dir/dev/dev_yx.data \
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    for mode in ${decode_modes}; do
    {
        ...
        python wenet/bin/recognize.py --gpu 0 \
            ...
            --test_data $feat_dir/dev/dev_yx.data \
         ...
         python tools/compute-wer.py --char=1 --v=1  $feat_dir/dev/text_yx $test_dir/text_pred > $test_dir/wer
...
if [ ${stage} -le 6 ] && [ ${stop_stage} -ge 6 ]; then
    ...
    dir=exp/conformer_unicode
    python  wenet/bin/export_jit.py \
        --config $dir/train.yaml \
        --checkpoint $dir/239.pt \
