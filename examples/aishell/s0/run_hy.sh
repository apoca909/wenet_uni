...
node_rank=0
# data
data=/audiodata6/zhaoang/aishell
data_url=www.openslr.org/resources/33

nj=16
feat_dir=raw_wav
dict=data/dict/lang_zh.txt
...
decode_modes="attention_rescoring" #ctc_greedy_search ctc_prefix_beam_search attention attention_rescoring
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
    ...
    for ((i = 0; i < $num_gpus; ++i)); do
    {
        ...
        python wenet/bin/train.py --gpu $gpu_id \
            --config $train_config \
            --train_data $feat_dir/$train_set/train_hy.data \
            --cv_data $feat_dir/dev/dev_hy1.data \
...
#          python -m torch.distributed.launch --nproc_per_node=$num_gpus wenet/bin/train.py \
#          --config $train_config \
#            --train_data $feat_dir/$train_set/train_hy.data \
#            --cv_data $feat_dir/dev/dev_hy1.data \
#            ${checkpoint:+--checkpoint $checkpoint} \
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    for mode in ${decode_modes}; do
    {
        ...
        python wenet/bin/recognize.py --gpu 0 \
            ...
            --test_data $feat_dir/dev/dev_hy1.data \
            ...
            --result_file $test_dir/text_pred \
            ${decoding_chunk_size:+--decoding_chunk_size $decoding_chunk_size}
         
         python tools/compute-wer.py --char=1 --v=1  $feat_dir/dev/text_dev_hy1 $test_dir/text_pred > $test_dir/wer
