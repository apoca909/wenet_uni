...
// TorchAsrModel flags
DEFINE_int32(num_threads, 4, "num threads for device");
...
DEFINE_double(beam, 15.0, "beam in ctc wfst search");
DEFINE_double(lattice_beam, 12.0, "lattice beam in ctc wfst search");
