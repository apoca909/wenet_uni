    ...
    def __init__(self,
        ...
        for i, dd in enumerate(data):
            ...
            if length > max_length or length < min_length:
                ...
                #     data[i][0], length))
                print('skip length > max_length or length < min_length')
                pass
            elif token_length > token_max_length or token_length < token_min_length:
                print('skip token_length > token_max_length or token_length < token_min_length')
                pass
            else:
